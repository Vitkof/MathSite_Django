...
SECRET_KEY = 'ztt3)i8p=i_t)z6)g81-0&mrjp-fdxc)&epm&r2t$dx7(%&8pj'# os.getenv('SECRET_KEY')
...
WSGI_APPLICATION = 'ctmath.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ctmath',  #os.getenv('DB_NAME'),
        'USER': 'root',   #os.getenv('DB_USER'),
        'PASSWORD': 'Imnfuo15',  #os.getenv('DB_PASSWORD'),
...
STATICFILES_DIRS = (Path(PROJECT_ROOT/'assets'), )
STATICFILES_FINDERS = (
